...
Site theme package for the dpf project based on Diazo and
plone.app.theming

* `Source code @ GitHub <https://github.com/kreativkombinat/dpf.sitetheme>`_
* `Releases @ PyPI <http://pypi.python.org/pypi/dpf.sitetheme>`_
* `Continuous Integration @ Travis-CI <http://travis-ci.org/kreativkombinat/dpf.sitetheme>`_
